...
def validateCubeString(cubes_str):
    whitecount = 0
    bluecount = 0
    redcount = 0
    yellowcount = 0
    ...
    for x in range(0, 54):
        ...
        if (x==8 or x==17 or x==26 or x==35 or x==44 or x==53):
            print("")
...
def main():
    ...
    #DEBUG
    print("Finished extracting colours")
    #print(cubes)
    ...
    # TODO Guard against trying to solve completed cubes
    if cubes_str == "UUUUUUUUURRRRRRRRRFFFFFFFFFDDDDDDDDDLLLLLLLLLBBBBBBBBB":
        print("Cube already solved.")
        return
        
############################################
    validateCubeString(cubes_str)
############################################
